        ...
        heroSection.innerHTML = `
            <div class="max-w-7xl px-4 sm:px-6 lg:px-8 min-h-44">
                ...
                <div class="absolute flex justify-center bg-gradient-to-t inset-0 p-5 to-transparent from-background flex-col gap-4 items-center">
                    <h1 class="text-3xl max-md:text-primary-foreground sm:text-4xl text-primary md:text-5xl font-bold">Oops! Error 404</h1>
                    <p class="text-lg md:text-xl mb-8 text-foreground/50" aria-live="polite">The page you're looking for cannot be found</p>
