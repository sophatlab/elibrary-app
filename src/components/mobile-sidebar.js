        ...
        this.sidebar.innerHTML = `
            <div class="flex flex-col h-full overflow-y-auto">
                ...
                <div class="flex items-center justify-between px-4 py-2 border-b border-border">
                    ...
                    <button type="button" class="p-2 hover:bg-foreground/5 rounded-lg transition-colors" id="close-mobile-sidebar" aria-label="Close sidebar">
                ...
                <div class="mt-auto p-4 border-t border-border">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <button type="button" class="p-2 hover:bg-foreground/5 rounded-lg transition-colors" id="mobile-theme-toggle" aria-label="Toggle theme">
                    ...
                    <a href="https://github.com/pphatdev" target="_blank" class="flex items-center justify-between  py-2 pr-2 hover:text-primary transition-colors" aria-label="GitHub profile">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <button type="button" class="p-2 hover:bg-foreground/5 rounded-lg transition-colors" id="mobile-search-toggle" aria-label="Open search">
                        <svg class="size-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1" stroke-linecap="round" stroke-linejoin="round">
